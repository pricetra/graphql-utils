...
export type UpdateBranchMutation = { __typename?: 'Mutation', updateBranch: { __typename?: 'Branch', id: number, name: string, storeId: number, addressId?: number | null, onlineAddressId?: number | null, address?: { __typename?: 'Address', id: number, latitude: number, longitude: number, mapsLink: string, fullAddress: string, street?: string | null, city: string, administrativeDivision: string, countryCode: string, country?: string | null, zipCode: string } | null, onlineAddress?: { __typename?: 'OnlineAddress', id: number, storeId: number, url: string, itemUrlTemplate?: string | null, referralCode?: string | null, referralQueryParam?: string | null } | null } };
