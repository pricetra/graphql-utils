...
export type CreateBranchFromFullAddressMutation = { __typename?: 'Mutation', createBranchWithFullAddress: { __typename?: 'Branch', id: number, name: string, addressId?: number | null, storeId: number, address?: { __typename?: 'Address', id: number, latitude: number, longitude: number, mapsLink: string, fullAddress: string, street?: string | null, city: string, administrativeDivision: string, countryCode: string, country?: string | null, zipCode: string } | null } };
...
export type CreateBranchMutation = { __typename?: 'Mutation', createBranch: { __typename?: 'Branch', id: number, name: string, addressId?: number | null, storeId: number, address?: { __typename?: 'Address', id: number, latitude: number, longitude: number, mapsLink: string, fullAddress: string, street?: string | null, city: string, administrativeDivision: string, countryCode: string, country?: string | null, zipCode: string } | null } };
