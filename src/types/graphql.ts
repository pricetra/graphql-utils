...
export type CreatePriceMutation = { __typename?: 'Mutation', createPrice: { __typename?: 'Price', id: number, amount: number, currencyCode: string, productId: number, storeId: number, stockId: number, branchId: number } };
