...
export type CreateStoreWithBusinessFormMutation = { __typename?: 'Mutation', createStoreWithBusinessForm: { __typename?: 'BusinessFormSignedUp', businessForm: { __typename?: 'BusinessForm', id: string, firstName: string, lastName: string, email: string, phoneNumber?: string | null, storeName: string, storeAddress: string, storeUrl: string, storeLogo: string, additionalInformation?: string | null, storeId?: number | null }, store: { __typename?: 'Store', id: number, slug: string, name: string, logo: string, website: string }, branch: { __typename?: 'Branch', id: number, slug: string, name: string, addressId?: number | null, storeId: number, storeSlug?: string | null, address?: { __typename?: 'Address', id: number, fullAddress: string, latitude: number, longitude: number } | null } } };
...
export type BusinessSingUpFormMutation = { __typename?: 'Mutation', businessSingUpForm: { __typename?: 'BusinessForm', id: string, firstName: string, lastName: string, email: string, phoneNumber?: string | null, storeName: string, storeAddress: string, storeUrl: string, storeLogo: string, additionalInformation?: string | null, storeId?: number | null } };
