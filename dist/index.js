...
__export(src_exports, {
  ...
  ADMIN_REMOVE_AUTH_SESSION_MUTATION: () => ADMIN_REMOVE_AUTH_SESSION_MUTATION,
  ALL_BRANCHES_QUERY: () => ALL_BRANCHES_QUERY,
  ALL_BRANDS_QUERY: () => ALL_BRANDS_QUERY,
  ALL_BUSINESS_FORM_SIGN_UPS_QUERY: () => ALL_BUSINESS_FORM_SIGN_UPS_QUERY,
  ALL_PRODUCTS_QUERY: () => ALL_PRODUCTS_QUERY,
  ALL_STORES_QUERY: () => ALL_STORES_QUERY,
  APPLE_OAUTH_QUERY: () => APPLE_OAUTH_QUERY,
  AcceptPendingStoreUserInviteDocument: () => AcceptPendingStoreUserInviteDocument,
  ...
  AddressAutocompleteDocument: () => AddressAutocompleteDocument,
  AddressFromLatLonDocument: () => AddressFromLatLonDocument,
  AddressFromPlaceIdDocument: () => AddressFromPlaceIdDocument,
  AddressFromRawStringDocument: () => AddressFromRawStringDocument,
  AdminRemoveAuthSessionDocument: () => AdminRemoveAuthSessionDocument,
  AllBranchesDocument: () => AllBranchesDocument,
  AllBrandsDocument: () => AllBrandsDocument,
  AllBusinessFormSignUpsDocument: () => AllBusinessFormSignUpsDocument,
  AllProductsDocument: () => AllProductsDocument,
  AllStoresDocument: () => AllStoresDocument,
  AppendStorefrontBannerItemsDocument: () => AppendStorefrontBannerItemsDocument,
  AppleOAuthDocument: () => AppleOAuthDocument,
  ...
  BUSINESS_SIGN_UP_FORM_MUTATION: () => BUSINESS_SIGN_UP_FORM_MUTATION,
  ...
  BusinessSingUpFormDocument: () => BusinessSingUpFormDocument,
  CATEGORIES_WITH_PRODUCTS_QUERY: () => CATEGORIES_WITH_PRODUCTS_QUERY,
  ...
  CREATE_PRODUCT_AND_SANITIZE_MUTATION: () => CREATE_PRODUCT_AND_SANITIZE_MUTATION,
  CREATE_PRODUCT_MUTATION: () => CREATE_PRODUCT_MUTATION,
  CREATE_STORE_MUTATION: () => CREATE_STORE_MUTATION,
  CREATE_STORE_USER_ADMIN: () => CREATE_STORE_USER_ADMIN,
  CREATE_STORE_WITH_BUSINESS_FORM_MUTATION: () => CREATE_STORE_WITH_BUSINESS_FORM_MUTATION,
  CREATE_USER_MUTATION: () => CREATE_USER_MUTATION,
  CategoriesWithProductsDocument: () => CategoriesWithProductsDocument,
  ...
  CreateProductAndSanitizeDocument: () => CreateProductAndSanitizeDocument,
  CreateProductDocument: () => CreateProductDocument,
  CreateStoreDocument: () => CreateStoreDocument,
  CreateStoreUserAdminDocument: () => CreateStoreUserAdminDocument,
  CreateStoreWithBusinessFormDocument: () => CreateStoreWithBusinessFormDocument,
  CreateStorefrontBannerItemsDocument: () => CreateStorefrontBannerItemsDocument,
  CreateStorefrontFlyerDocument: () => CreateStorefrontFlyerDocument,
  CreateStorefrontFlyerPageDocument: () => CreateStorefrontFlyerPageDocument,
  ...
  DELETE_MY_ACCOUNT_MUTATION: () => DELETE_MY_ACCOUNT_MUTATION,
  DeclinePendingStoreUserInviteDocument: () => DeclinePendingStoreUserInviteDocument,
  DefaultGroceryListItemsDocument: () => DefaultGroceryListItemsDocument,
  DeleteAllStorefrontBannerItemsDocument: () => DeleteAllStorefrontBannerItemsDocument,
  DeleteGroceryListItemDocument: () => DeleteGroceryListItemDocument,
  DeleteMyAccountDocument: () => DeleteMyAccountDocument,
  DeleteStorefrontBannerItemDocument: () => DeleteStorefrontBannerItemDocument,
  DeleteStorefrontFlyerDocument: () => DeleteStorefrontFlyerDocument,
  DeleteStorefrontFlyerPageDocument: () => DeleteStorefrontFlyerPageDocument,
  EDIT_BUSINESS_SIGN_UP_FORM_MUTATION: () => EDIT_BUSINESS_SIGN_UP_FORM_MUTATION,
  ...
  EditBusinessFormDocument: () => EditBusinessFormDocument,
  ...
  GetStorefrontBannerDocument: () => GetStorefrontBannerDocument,
  ...
  MyStoreUserDocument: () => MyStoreUserDocument,
  OrderByType: () => OrderByType,
  PAGINATED_ADMIN_AUTH_SESSIONS_QUERY: () => PAGINATED_ADMIN_AUTH_SESSIONS_QUERY,
  PAGINATED_ADMIN_PRODUCT_VIEW_ENTRIES: () => PAGINATED_ADMIN_PRODUCT_VIEW_ENTRIES,
  PAGINATED_PENDING_CRAWLED_PRODUCTS_QUERY: () => PAGINATED_PENDING_CRAWLED_PRODUCTS_QUERY,
  ...
  PaginatedAdminAuthSessionsDocument: () => PaginatedAdminAuthSessionsDocument,
  PaginatedAdminProductViewEntriesDocument: () => PaginatedAdminProductViewEntriesDocument,
  PaginatedPendingCrawledProductsDocument: () => PaginatedPendingCrawledProductsDocument,
  ...
  PublishDraftStorefrontFlyerDocument: () => PublishDraftStorefrontFlyerDocument,
  ...
  SAVE_PENDING_PRODUCT_MUTATION: () => SAVE_PENDING_PRODUCT_MUTATION,
  SEARCH_KEYWORDS_QUERY: () => SEARCH_KEYWORDS_QUERY,
  STOREFRONT_SETUP_TASKS: () => STOREFRONT_SETUP_TASKS,
  STORE_SLUG_AVAILABILITY_QUERY: () => STORE_SLUG_AVAILABILITY_QUERY,
  SanitizeProductDocument: () => SanitizeProductDocument,
  SavePendingProductDocument: () => SavePendingProductDocument,
  SearchKeywordsDocument: () => SearchKeywordsDocument,
  StockDocument: () => StockDocument,
  StoreSlugAvailabilityDocument: () => StoreSlugAvailabilityDocument,
  StoreUserAuthorizedDocument: () => StoreUserAuthorizedDocument,
  StoreUserRole: () => StoreUserRole,
  StorefrontFlyerDocument: () => StorefrontFlyerDocument,
  StorefrontFlyerFormat: () => StorefrontFlyerFormat,
  StorefrontFlyerSimpleDocument: () => StorefrontFlyerSimpleDocument,
  StorefrontFlyerStatus: () => StorefrontFlyerStatus,
  StorefrontFlyersDocument: () => StorefrontFlyersDocument,
  StorefrontSetupTaskType: () => StorefrontSetupTaskType,
  StorefrontSetupTasksDocument: () => StorefrontSetupTasksDocument,
  ...
  UPDATE_STORE_MUTATION: () => UPDATE_STORE_MUTATION,
  UPDATE_USER_BY_ID_MUTATION: () => UPDATE_USER_BY_ID_MUTATION,
  UpdateBranchDocument: () => UpdateBranchDocument,
  ...
  UpdateStoreDocument: () => UpdateStoreDocument,
  UpdateStorefrontBannerItemDocument: () => UpdateStorefrontBannerItemDocument,
  UpdateStorefrontFlyerDocument: () => UpdateStorefrontFlyerDocument,
  ...
  YAHOO_OAUTH_QUERY: () => YAHOO_OAUTH_QUERY,
  YahooOAuthDocument: () => YahooOAuthDocument,
  graphql: () => graphql,
...
var AuthPlatformType = /* @__PURE__ */ ((AuthPlatformType2) => {
  ...
  AuthPlatformType2["Yahoo"] = "YAHOO";
  return AuthPlatformType2;
})(AuthPlatformType || {});
var BranchType = /* @__PURE__ */ ((BranchType2) => {
  BranchType2["Online"] = "ONLINE";
  BranchType2["Physical"] = "PHYSICAL";
  return BranchType2;
})(BranchType || {});
...
var StoreUserRole = /* @__PURE__ */ ((StoreUserRole2) => {
  StoreUserRole2["Accounting"] = "ACCOUNTING";
  StoreUserRole2["Admin"] = "ADMIN";
  StoreUserRole2["Associate"] = "ASSOCIATE";
  StoreUserRole2["Auditor"] = "AUDITOR";
  StoreUserRole2["Inventory"] = "INVENTORY";
  StoreUserRole2["It"] = "IT";
  StoreUserRole2["Manager"] = "MANAGER";
  StoreUserRole2["Marketing"] = "MARKETING";
  StoreUserRole2["Other"] = "OTHER";
  StoreUserRole2["Owner"] = "OWNER";
  StoreUserRole2["Sales"] = "SALES";
  StoreUserRole2["Supervisor"] = "SUPERVISOR";
  return StoreUserRole2;
})(StoreUserRole || {});
var StorefrontFlyerFormat = /* @__PURE__ */ ((StorefrontFlyerFormat2) => {
  StorefrontFlyerFormat2["A4"] = "A4";
  StorefrontFlyerFormat2["Legal"] = "Legal";
  StorefrontFlyerFormat2["Letter"] = "Letter";
  return StorefrontFlyerFormat2;
})(StorefrontFlyerFormat || {});
var StorefrontFlyerStatus = /* @__PURE__ */ ((StorefrontFlyerStatus2) => {
  StorefrontFlyerStatus2["Archived"] = "ARCHIVED";
  StorefrontFlyerStatus2["Deleted"] = "DELETED";
  StorefrontFlyerStatus2["Draft"] = "DRAFT";
  StorefrontFlyerStatus2["Published"] = "PUBLISHED";
  StorefrontFlyerStatus2["Scheduled"] = "SCHEDULED";
  return StorefrontFlyerStatus2;
})(StorefrontFlyerStatus || {});
var StorefrontSetupTaskType = /* @__PURE__ */ ((StorefrontSetupTaskType2) => {
  StorefrontSetupTaskType2["Banner"] = "BANNER";
  StorefrontSetupTaskType2["Branch"] = "BRANCH";
  StorefrontSetupTaskType2["Details"] = "DETAILS";
  StorefrontSetupTaskType2["Hours"] = "HOURS";
  StorefrontSetupTaskType2["Logo"] = "LOGO";
  StorefrontSetupTaskType2["Promotion"] = "PROMOTION";
  StorefrontSetupTaskType2["Stocks"] = "STOCKS";
  return StorefrontSetupTaskType2;
})(StorefrontSetupTaskType || {});
...
var DeleteMyAccountDocument = { "kind": "Document", "definitions": [{ "kind": "OperationDefinition", "operation": "mutation", "name": { "kind": "Name", "value": "DeleteMyAccount" }, "selectionSet": { "kind": "SelectionSet", "selections": [{ "kind": "Field", "name": { "kind": "Name", "value": "deleteMyAccount" } }] } }] };
...
`);
var PAGINATED_ADMIN_AUTH_SESSIONS_QUERY = (0, import_client.gql)(`
  query PaginatedAdminAuthSessions($paginator: PaginatorInput!, $filters: UserFilter) {
    paginatedAdminAuthSessions(paginator: $paginator, filters: $filters) {
      authSessions {
        id
...
`);
var PAGINATED_ADMIN_PRODUCT_VIEW_ENTRIES = (0, import_client.gql)(`
  query PaginatedAdminProductViewEntries($paginator: PaginatorInput!) {
    paginatedAdminProductViewEntries(paginator: $paginator) {
      productViewEntries {
        id
...
`);
var BRANCHES_WITH_PRODUCTS_QUERY = (0, import_client2.gql)(`
  query BranchesWithProducts($paginator: PaginatorInput!, $productLimit: Int!, $filters: ProductSearch) {
    branchesWithProducts(
      paginator: $paginator
      productLimit: $productLimit
...
`);
var CATEGORIES_WITH_PRODUCTS_QUERY = (0, import_client4.gql)(`
  query CategoriesWithProducts($paginator: PaginatorInput!, $productLimit: Int!, $filters: ProductSearch) {
    categoriesWithProducts(
      paginator: $paginator
      productLimit: $productLimit
...
`);
var PAGINATED_PENDING_CRAWLED_PRODUCTS_QUERY = (0, import_client10.gql)(`
  query PaginatedPendingCrawledProducts($paginator: PaginatorInput!){
    paginatedPendingCrawledProducts(paginator: $paginator) {
      pendingCrawledProducts {
        upc
...
`);
var STORE_SLUG_AVAILABILITY_QUERY = (0, import_client13.gql)(`
  query StoreSlugAvailability($store: String!) {
    storeSlugAvailability(store: $store)
  }
`);
var STOREFRONT_SETUP_TASKS = (0, import_client13.gql)(`
  query StorefrontSetupTasks($storeId: ID!, $branchId: ID) {
    storefrontSetupTasks(storeId: $storeId, branchId: $branchId) {
      taskType
      title
...
`);
var ALL_BUSINESS_FORM_SIGN_UPS_QUERY = (0, import_client13.gql)(`
  query AllBusinessFormSignUps($paginator: PaginatorInput!, $showCompleted: Boolean) {
    allBusinessFormSignUps(paginator: $paginator, showCompleted: $showCompleted) {
      businessForms {
        id
...
`);
var APPLE_OAUTH_QUERY = (0, import_client14.gql)(`
  query AppleOAuth(
    $code: String!
    $appleRawUser: String
    $ipAddress: String
...
`);
var YAHOO_OAUTH_QUERY = (0, import_client14.gql)(`
  query YahooOAuth($code: String!, $codeVerifier: String, $ipAddress: String, $device: AuthDeviceType) {
    yahooOAuth(code: $code, codeVerifier: $codeVerifier, ipAddress: $ipAddress, device: $device) {
      token
      user {
...
`);
var CREATE_STORE_USER_ADMIN = (0, import_client15.gql)(`
  mutation CreateStoreUserAdmin($input: CreateStoreUserAdmin!) {
    createStoreUserAdmin(input:$input) {
      id
      storeId
...
`);
var ADMIN_REMOVE_AUTH_SESSION_MUTATION = (0, import_client15.gql)(`
  mutation AdminRemoveAuthSession($authStateId: String!) {
    adminRemoveAuthSession(authStateId: $authStateId)
  }
`);
var CREATE_STORE_WITH_BUSINESS_FORM_MUTATION = (0, import_client15.gql)(`
  mutation CreateStoreWithBusinessForm($id: String!) {
    createStoreWithBusinessForm(id: $id) {
      businessForm {
        id
...
`);
var UPDATE_BRANCH_MUTATION = (0, import_client16.gql)(`
  mutation UpdateBranch($storeId: ID!, $branchId: ID!, $input: UpdateBranch!) {
    updateBranch(storeId: $storeId, branchId: $branchId, input: $input) {
      id
      slug
...
`);
var CREATE_PRODUCT_AND_SANITIZE_MUTATION = (0, import_client22.gql)(`
  mutation CreateProductAndSanitize($input: CreateProductRaw!) {
    createProductAndSanitize(input: $input) {
      id
      name
...
`);
var SAVE_PENDING_PRODUCT_MUTATION = (0, import_client22.gql)(`
  mutation SavePendingProduct($upc: String!) {
    savePendingProduct(upc: $upc) {
      id
      name
...
`);
var BUSINESS_SIGN_UP_FORM_MUTATION = (0, import_client23.gql)(`
  mutation BusinessSingUpForm($input: BusinessFormInput!) {
    businessSingUpForm(input: $input) {
      id
      firstName
...
`);
var UPDATE_STORE_MUTATION = (0, import_client23.gql)(`
  mutation UpdateStore($storeId: ID!, $input: UpdateStore!) {
    updateStore(storeId: $storeId, input: $input) {
      id
      name
...
`);
var EDIT_BUSINESS_SIGN_UP_FORM_MUTATION = (0, import_client23.gql)(`
  mutation EditBusinessForm($businessFormId: String!, $input: UpdateBusinessFormInput!) {
    editBusinessForm(businessFormId: $businessFormId, input: $input) {
      id
      firstName
...
`);
var DELETE_MY_ACCOUNT_MUTATION = (0, import_client24.gql)(`
  mutation DeleteMyAccount {
    deleteMyAccount
  }
`);
...
0 && (module.exports = {
  ...
  ADMIN_REMOVE_AUTH_SESSION_MUTATION,
  ALL_BRANCHES_QUERY,
  ALL_BRANDS_QUERY,
  ALL_BUSINESS_FORM_SIGN_UPS_QUERY,
  ALL_PRODUCTS_QUERY,
  ALL_STORES_QUERY,
  APPLE_OAUTH_QUERY,
  AcceptPendingStoreUserInviteDocument,
  ...
  BUSINESS_SIGN_UP_FORM_MUTATION,
  BarcodeScanDocument,
  BranchDocument,
  BranchType,
  BranchesWithProductsDocument,
  ...
  CREATE_PRODUCT_AND_SANITIZE_MUTATION,
  CREATE_PRODUCT_MUTATION,
  CREATE_STORE_MUTATION,
  CREATE_STORE_USER_ADMIN,
  CREATE_STORE_WITH_BUSINESS_FORM_MUTATION,
  ...
  DeleteStorefrontFlyerDocument,
  DeleteStorefrontFlyerPageDocument,
  EDIT_BUSINESS_SIGN_UP_FORM_MUTATION,
  ...
  MyStoreUserDocument,
  OrderByType,
  PAGINATED_ADMIN_AUTH_SESSIONS_QUERY,
  PAGINATED_ADMIN_PRODUCT_VIEW_ENTRIES,
  PAGINATED_PENDING_CRAWLED_PRODUCTS_QUERY,
  ...
  SAVE_PENDING_PRODUCT_MUTATION,
  SEARCH_KEYWORDS_QUERY,
  STOREFRONT_SETUP_TASKS,
  STORE_SLUG_AVAILABILITY_QUERY,
  SanitizeProductDocument,
  SavePendingProductDocument,
  SearchKeywordsDocument,
  StockDocument,
